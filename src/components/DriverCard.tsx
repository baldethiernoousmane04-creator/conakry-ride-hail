...
export const DriverCard: React.FC<DriverCardProps> = ({ rideName, category, onCancel }) => {
    ...
    >
      ...
      <div className="flex items-center gap-4 bg-gray-50 p-4 rounded-2xl">
        ...
        <div className="flex-grow">
          <h3 className="font-bold text-gray-900">Mamadou Sylla</h3>
      ...
      <div className="space-y-3">
        <div className="flex justify-between items-center text-sm">
          <span className="text-gray-500">Paiement à l'arrivée</span>
